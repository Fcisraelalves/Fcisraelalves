...
- Estudante de programação com foco em **Desenvolvimento Backend** e **Machine Learning**.
- Interessado em **Processamento de Linguagem Natural (NLP)**, **Visão Computacional** e **Arquitetura de Software**.
- Meu objetivo é integrar **Inteligência Artificial** e **Desenvolvimento de Software** para criar soluções robustas, seguras e escaláveis.
